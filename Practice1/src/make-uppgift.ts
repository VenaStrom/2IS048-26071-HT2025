...
const templatePath = "Practice1/src/uppgifter/UppgiftX.cs";

const existingUppgifter = fs.readdirSync("Practice1/src/uppgifter");
...
const newUppgiftPath = `Practice1/src/uppgifter/Uppgift${nextUppgiftNumber}.cs`;
